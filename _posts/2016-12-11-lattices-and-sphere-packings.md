...
Let $$\Lambda_0$$ be the laminated lattice in zero dimensions, consisting of a single point. Take the set of all $$n$$-dimensional lattices (for $$n \geq 1$$) with minimal distance 2 having at least one sublattice $$\Lambda_{n-1}$$ that is laminated. Any lattice having minimal determinant in this set is a laminated lattice.
